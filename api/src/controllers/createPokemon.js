...
const createPokemonDb = async (id, name, image, hp, attack, defense,type ) => {
    const pokemon = await Pokemon.create({id, name, image, hp, attack, defense, createdByUser: true, types: type})
